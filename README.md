...
- using ssh key <br>
```shell
$ git clone git@github.com:ShermanA-13/rails_engine.git
```

- using https <br>
```shell
$ git clone  https://github.com/ShermanA-13/rails_engine.git
```
...
Finally, in order to use the api you will have to start the server locally and access the app through a endpoint request service like Postman.
- Start server
```shell
$ rails s
```

At this point you should be access the endpoints of the api. If you encounter any errors or have not reached the api endpoints please confirm you followed the steps above and that your environment is properly set up.
